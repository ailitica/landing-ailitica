...
(function () {
  ...
  var CSS = [
    ...
    '  font-weight:400; color:#1B1D22;',
    '  background:rgba(255,255,255,0.96);',
    '  -webkit-backdrop-filter:blur(22px); backdrop-filter:blur(22px);',
    '  border-top:1px solid #E2E0D9;',
    '  padding:14px clamp(18px,4vw,56px);',
    '  padding-bottom:calc(14px + env(safe-area-inset-bottom, 0px));',
    '  box-shadow:0 -18px 48px rgba(27,29,34,0.10);',
    '}',
    ...
    '.ailitica-consent__texto { font-size:13px; line-height:1.4; color:#4A4F5A; margin:0; }',
    '.ailitica-consent__texto a { color:#1F6FEB; text-decoration:underline; text-underline-offset:3px; }',
    ...
    /* Banner compacto (especificación de Forma, 7-sep-2026): fila única con dos
       botones idénticos y "Configurar" como enlace de texto. El selector va
    ...
    '  color:#1F6FEB; background:none; border:none;',
    '  text-decoration:underline; text-underline-offset:3px;',
    '  cursor:inherit; -webkit-tap-highlight-color:transparent;',
    '}',
    '.ailitica-consent__enlace:focus-visible { outline:2px solid #1F6FEB; outline-offset:3px; }',
    ...
    '  color:#1B1D22; background:#F4F3EF;',
    '  border:1.5px solid #E2E0D9; border-radius:999px;',
    '  cursor:inherit; -webkit-tap-highlight-color:transparent;',
    '  transition:background .18s, border-color .18s;',
    '}',
    '.ailitica-consent__boton:hover { background:#EEF4FF; border-color:#1F6FEB; }',
    '.ailitica-consent__boton:active { background:#E2E0D9; }',
    '.ailitica-consent__boton:focus-visible { outline:2px solid #1F6FEB; outline-offset:3px; }',
    ...
    '  background:#FFFFFF; color:#1B1D22;',
    '  border:1px solid #E2E0D9;',
    '  border-radius:24px 24px 0 0;',
    '  box-shadow:0 -20px 50px rgba(27,29,34,0.12);',
    ...
    '  font-family:"Manrope",system-ui,sans-serif;',
    '  font-size:20px; font-weight:700; letter-spacing:-.015em; margin:0 0 8px;',
    '}',
    '.ailitica-consent__panel p { font-size:13.5px; line-height:1.7; color:#4A4F5A; margin:0 0 14px; }',
    '.ailitica-consent__panel a { color:#1F6FEB; text-decoration:underline; text-underline-offset:3px; }',
    '.ailitica-consent__grupo {',
    '  border:1.5px solid #E2E0D9; border-radius:18px;',
    '  padding:16px 18px; margin-bottom:14px;',
    '}',
    '.ailitica-consent__grupo h3 {',
    '  font-family:"Manrope",system-ui,sans-serif;',
    '  font-size:14px; font-weight:700; margin:0 0 6px; color:#1B1D22;',
    '}',
    '.ailitica-consent__grupo p { margin:0 0 8px; font-size:13px; }',
    '.ailitica-consent__fija { font-size:12px; letter-spacing:.06em; text-transform:uppercase; color:#8A8F99; }',
    '.ailitica-consent__interruptor {',
    '  display:flex; align-items:center; gap:12px; min-height:46px;',
    '  padding:8px 0; font-size:14px; color:#1B1D22; cursor:inherit;',
    '}',
    '.ailitica-consent__interruptor input { width:22px; height:22px; accent-color:#1F6FEB; flex:0 0 auto; cursor:inherit; }',
  ...
  function anadirEnlacePie() {
    ...
    enlace.style.cssText = 'color:#8A8F99; text-decoration:none;';
